...
<a class="font-display text-headline-lg-mobile text-primary tracking-tight scale-105 transition-transform duration-400 ease-out-expo hover:opacity-80 flex items-center gap-2" href="/" aria-label="GeotaggingPhotos Homepage">
<span class="material-symbols-outlined text-secondary" aria-hidden="true">add_location_alt</span>
...
<a href="/" class="font-display text-headline-lg-mobile text-primary hover:opacity-80 transition-opacity">GeotaggingPhotos</a>
